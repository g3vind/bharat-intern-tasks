        ...
        <ul className="flex justify-evenly items-center my-5 md:my-0 md:space-x-5 md:mr-5">
          ...
          <button
            onClick={() => {
              ...
              downloadLink.href = 'https://drive.google.com/file/d/1-e_GpS5brYFJhx09M1svP9ZFYFrzXSqT/view?usp=drive_link';
              downloadLink.download = 'Resume.pdf'; // Set the desired file name
